var finalEventMap = finalEventMap || {};

finalEventMap.initialize = function() {
  var mapCanvas = $('#map-canvas-final')[0];
  var pathId = parseInt($('#venue_id').val());
...
google.maps.event.addDomListener(window, 'load', finalEventMap.initialize);